...
public class ContentController {
     ...
     * @Date 16:02 2020/2/23
     * @param categoryId
     * @return entity.Result<java.util.List<com.changgou.content.pojo.Content>>
     **/
    @GetMapping("/list/category/{categoryId}")
    public Result<List<Content>> findListByCategoryId(@PathVariable(value = "categoryId") Long categoryId){
        List<Content> list = contentService.findListByCategoryId(categoryId);
