...
public class SpuController {
    ...
    /**
     * @author 栗子
     * @Description 商品上/下架操作
     * @Date 15:53 2020/2/21
     * @param id
     * @param isMarketable
    ...
    public Result audit(@PathVariable(value = "id") Long id,
        ...
        return new Result(true, StatusCode.OK, "审核操作成功");
    }

    /**
     * @author 栗子
     * @Description 商品保存
     * @Date 14:52 2020/2/21
     * @param goods
     * @return entity.Result
     **/
    @PostMapping("/save")
    ...
    public Result<Goods> findGoodsById(@PathVariable(value = "id") Long id){
        ...
        return new Result<>(true, StatusCode.OK, "回显成功", goods);
    }
