...
public class CategoryController {
     ...
     * @author 栗子
     * @Description 加载商品分类
     * @Date 11:31 2020/2/21
     * @param pid
     * @return entity.Result<java.util.List<com.changgou.goods.pojo.Category>>
     **/
    @GetMapping("/findListByParentId/{pid}")
    public Result<List<Category>> findListByParentId(@PathVariable(value = "pid") Integer pid){
        List<Category> list = categoryService.findListByParentId(pid);
